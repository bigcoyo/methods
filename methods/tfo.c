...
void setup_tcp_header(struct tcphdr *tcph)
{
    ...
    tcph->check = 0;
    memcpy((void *)tcph + sizeof(struct tcphdr), "\x02\x04\x05\xb4\x04\x02\x08\x0a\x00\xd9\x68\xa3\x04\x02\x08\x0a\x00\xd9\x68\xa3\x00\x04\x02\x08\x0a\x00\xd9\x68\xa3\x00\x00\x00\x00\x00\x01\x03\x03\x07\xfe\x04\xf9\x89", 24); // tcp options
    tcph->syn = 1;
